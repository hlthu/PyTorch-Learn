...
class DynamicNet(nn.Module):
    def __init__(self):
        ...
        self.hidden_linear1 = nn.Linear(20*6*6, 20*6*6)
        self.hidden_linear2 = nn.Linear(20*6*6, 20*6*6)
        self.hidden_linear3 = nn.Linear(20*6*6, 20*6*6)
    ...
    def forward(self, x):
        ...
        h_relu = F.relu(self.hidden_linear1(h_relu))
        h_relu = F.relu(self.hidden_linear2(h_relu))
        h_relu = F.relu(self.hidden_linear3(h_relu))
